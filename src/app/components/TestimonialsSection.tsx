...
const testimonials = [
  {
    ...
    text: "Cicely made our New Year's Eve wedding absolutely magical. We couldn't wait another day to get married, and she made it happen with such grace and warmth. Starting our new year as husband and wife was the best decision we ever made."
  },
  {
    name: "Jennifer & David",
    ...
    text: "We needed to get married quickly, and Cicely was there for us. Professional, compassionate, and made our simple ceremony feel incredibly special. She truly cares about every couple she serves."
  },
  {
    name: "Amanda & Robert",
    ...
    text: "Our Arizona desert wedding was like a dream, and Cicely was the perfect officiant. She understood our vision and created a ceremony that was both elegant and deeply personal. We couldn't have asked for more."
  },
  {
    name: "Lisa & Mark",
    ...
    text: "From our first conversation to saying 'I do,' Cicely made everything seamless. Her warmth and professionalism gave us the confidence to enjoy every moment. She's not just an officiant—she's a blessing."
  }
];
