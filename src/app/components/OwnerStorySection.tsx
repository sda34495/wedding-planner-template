        ...
        >
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#d4af37]/20 to-[#f7d76e]/20 rounded-full border border-[#d4af37]/30 mb-6">
              ...
              <span className="font-['Inter'] text-[#d4af37] text-sm uppercase tracking-wider">Meet Your Officiant</span>
            </div>
            
            <h2 className="font-['Playfair_Display'] text-5xl md:text-7xl text-[#f7e7ce] mb-6 leading-tight">
              About
              <br />
              <span className="text-[#d4af37]">Cicely Denean Cobb</span>
            </h2>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="relative rounded-2xl overflow-hidden border-4 border-[#d4af37]/30"
              >
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1623594675959-02360202d4d6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjB3b21hbiUyMHBvcnRyYWl0fGVufDF8fHx8MTc2Nzg1Nzk5Nnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
                  alt="Cicely Denean Cobb - Wedding Officiant"
                  className="w-full aspect-[4/5] object-cover"
                />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#0a0a0a] via-[#0a0a0a]/80 to-transparent p-6">
                  <p className="font-['Playfair_Display'] text-2xl text-[#d4af37]">Cicely Denean Cobb</p>
                  <p className="font-['Inter'] text-[#f7e7ce]">Licensed Wedding Officiant</p>
                </div>
              </motion.div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <motion.div
                  ...
                  className="relative rounded-xl overflow-hidden border-2 border-[#d4af37]/20"
                >
                  <ImageWithFallback
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <motion.div
                    ...
                    className="bg-gradient-to-br from-[#1a1a1a] to-[#141414] border border-[#d4af37]/20 rounded-xl p-6 text-center hover:border-[#d4af37]/50 transition-all"
                  >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-gradient-to-r from-[#1a1a1a]/50 via-[#141414]/80 to-[#1a1a1a]/50 border-l-4 border-[#d4af37] rounded-r-2xl p-10 max-w-5xl mx-auto"
          >
            ...
            <p className="font-['Inter'] text-[#d4af37] text-center">
              — Cicely Denean Cobb
            </p>
          </motion.div>
        </motion.div>
