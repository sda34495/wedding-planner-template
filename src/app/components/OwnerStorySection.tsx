...
export function OwnerStorySection() {
  return (
    <section className="relative py-24 px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5" style={{
        backgroundImage: 'radial-gradient(circle at 2px 2px, #f7e7ce 1px, transparent 0)',
        ...
        >
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#f7e7ce]/20 to-[#f7d76e]/20 rounded-full border border-[#f7e7ce]/30 mb-6">
              ...
              <span className="font-['Inter'] text-[#f7e7ce] text-sm uppercase tracking-wider">Meet Deluxe Decor</span>
            </div>
            
            <h2 className="font-['Playfair_Display'] text-5xl md:text-7xl text-[#f7e7ce] mb-6 leading-tight">
              About
              <br />
              <span className="text-[#f7e7ce]">Deluxe Decor</span>
            </h2>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="relative rounded-2xl overflow-hidden border-4 border-[#f7e7ce]/30"
              >
                <ImageWithFallback
                  src="/images/deluxe.jpeg"
                  alt="Deluxe Decor - Event Planner"
                  className="w-full aspect-[4/5] object-cover"
                />
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#0a0a0a] via-[#0a0a0a]/80 to-transparent p-6">
                  <p className="font-['Playfair_Display'] text-2xl text-[#f7e7ce]">Dafne Valadez </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <motion.div
                  ...
                  transition={{ delay: 0.2 }}
                    className="relative rounded-xl overflow-hidden border-2 border-[#f7e7ce]/20"
                >
                  <ImageWithFallback
                    ...
                    alt="Dafne officiating ceremony"
  ...
  >
    ...
    <div className="space-y-4 font-['Inter'] text-lg text-[#a8a8a8] leading-relaxed">
      <p>
        At Deluxe Decor, event planning isn’t just our profession—it’s our passion. We believe that every celebration, from intimate gatherings to grand galas, deserves to be executed flawlessly with creativity, precision, and style.
      </p>
      <p>
      ...
      <p className="text-[#f7e7ce] italic">
        "With Deluxe Decor, your event isn’t just planned—it’s brought to life with passion, creativity, and perfection."
      </p>
    </div>
  </motion.div>
  ...
  <div className="grid grid-cols-2 gap-4">
    {[
      ...
      <motion.div
        ...
        className="bg-gradient-to-br from-[#1a1a1a] to-[#141414] border border-[#f7e7ce]/20 rounded-xl p-6 text-center hover:border-[#f7e7ce]/50 transition-all"
      >
        <stat.icon className="w-8 h-8 text-[#f7e7ce] mx-auto mb-3" />
        ...
        <p className="font-['Playfair_Display'] text-lg text-[#f7e7ce]">{stat.value}</p>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-gradient-to-r from-[#1a1a1a]/50 via-[#141414]/80 to-[#1a1a1a]/50 border-l-4 border-[#f7e7ce] rounded-r-2xl p-10 max-w-5xl mx-auto"
          >
            ...
            <p className="font-['Inter'] text-[#f7e7ce] text-center">
              — Deluxe Decor
            </p>
          </motion.div>
        </motion.div>
