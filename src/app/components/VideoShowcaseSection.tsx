        ...
        >
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#d4af37]/20 to-[#f7d76e]/20 rounded-full border border-[#d4af37]/30 mb-6">
              ...
              <span className="font-['Inter'] text-[#d4af37] text-sm uppercase tracking-wider">Ceremony Highlights</span>
            </div>

            <h2 className="font-['Playfair_Display'] text-5xl md:text-7xl text-[#f7e7ce] mb-6 leading-tight">
              See the Magic
              <br />
              <span className="text-[#d4af37]">Come to Life</span>
            </h2>
          ...
          >
            <div className="relative aspect-video rounded-2xl overflow-hidden border-2 border-[#d4af37]/30 group">
              {!isPlaying ? (
                <>
                  <ImageWithFallback
                  ...
                  <button
                    ...
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 bg-gradient-to-r from-[#d4af37] to-[#f7d76e] rounded-full flex items-center justify-center transition-all hover:scale-110 shadow-2xl shadow-[#d4af37]/50 group-hover:shadow-[#d4af37]/70"
                  >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {videos.map((video, index) => (
              <motion.div
                ...
                className="relative aspect-video rounded-xl overflow-hidden border border-[#d4af37]/20 hover:border-[#d4af37]/50 transition-all cursor-pointer group"
              >
                <ImageWithFallback
                  src={video.thumbnail}
                  alt={video.title}
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-[#d4af37]/90 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all">
